...
[![Build Status](https://travis-ci.org/mafintosh/dwebfs.svg?branch=master)](https://travis-ci.org/mafintosh/dwebfs)
...
- If you require complete control, you can also pass in an object containing a `metadata` and a `content` field. Both of these need to be functions, and are called with the following arguments:
  ...
  - `archive`: the current DWebFs instance
...
Send an extension message to connected peers. [Read more in the ddatabase docs](https://github.com/distributedweb/ddatabase#feedextensionname-message).
