...
DWebFs.prototype.checkout = function (version) {
  return DWebFs(null, null, {
...
DWebFs.prototype._statDirectory = function (name, cb) {
...
DWebFs.prototype.access = function (name, cb) {
  this.stat(name, function (err) {
    cb(err)
  })
}

DWebFs.prototype.exists = function (name, cb) {
  this.access(name, function (err) {
    cb(!err)
  })
}

DWebFs.prototype.lstat = function (name, cb) {
  var self = this
...
DWebFs.prototype.stat = function (name, cb) {
  this.lstat(name, cb)
}
...
DWebFs.prototype.close = function (cb) {
  if (!cb) cb = noop
